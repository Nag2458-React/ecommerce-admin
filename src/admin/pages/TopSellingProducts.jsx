...
const TopSellingProducts = () => {
  ...
  const fetchProducts = async () => {
    ...
    const result = Object.values(salesMap).sort((a, b) => b.sold - a.sold);
  ...
  return (
    <div className="d-flex">
      ...
      <div className="container-fluid p-4" style={{width:"80%"}}>
        <h2 className="fw-bold mb-4">🏆 Top Selling Products</h2>
              ...
              <tbody>
                {products.map((item, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      <span className="badge bg-primary">{item.sold}</span>
                    </td>
